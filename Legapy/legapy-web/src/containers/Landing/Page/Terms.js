...
<br />The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at www.legapy.com.py , unless otherwise defined in this Privacy Policy.<br />
...
This Privacy Policy page was created at Privacy Policy Template.net.<br />
        </p>
    </div>
))
...
const Terms = observer(() =>
    <LandingBody footer={<Footer />} title={LandingStore.languagePack[LandingStore.currentLanguage].terms.title} />)
